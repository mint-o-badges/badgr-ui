...
@Component({
	selector: 'bg-collectionbadgecard',
	...
	template: `
		...
		<div class="badgecard-x-body">
			...
			<a *ngIf="badgeSlug" class="badgecard-x-title u-text-breakword" [routerLink]="['../collectionbadges', badgeSlug]">{{ badgeTitle }}</a>
...
export class BgCollectionBadgecard {
