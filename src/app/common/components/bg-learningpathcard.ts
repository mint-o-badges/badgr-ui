			...
			<div class="tw-flex tw-flex-col tw-justify-between tw-h-full">
				...
				<div class="tw-flex tw-flex-col tw-flex-wrap tw-py-2 tw-text-oebblack tw-mt-2 tw-gap-1">
					...
					<div class="tw-items-center">
						...
						<oeb-button *ngIf="isProgress && progress/studyLoad === 1 && !completed && !requested" (click)="requestLearningPath()" fonSize18="true" [text]="'Lernpfad-Badge abholen'</span>" width="full_width">							
						</oeb-button>
					</div>
