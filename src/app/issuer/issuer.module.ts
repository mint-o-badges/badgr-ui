...
} from './components/collectionbadge-selection-dialog/collectionbadgebadge-selection-dialog.component';
import { CollectionBadgeManager } from './services/collectionbadge-manager.service';
import { CollectionBadgeApiService } from './services/collectionbadge-api.service';
import { CollectionBadgeClassIssueComponent } from './components/collectionbadgeclass-issue/collectionbadgeclass-issue.component';
import { CollectionBadgeInstanceApiService } from './services/collectionbadge-instance-api.service';
...
const routes = [
	...
	{
		path: 'issuers/:issuerSlug/collectionbadges/:badgeSlug/issue',
		component: CollectionBadgeClassIssueComponent,
	},
	{
...
@NgModule({
	...
	declarations: [
		...
		CollectionBadgeClassIssueComponent,
	...
	providers: [
		...
		CollectionBadgeInstanceApiService,
		CollectionBadgeInstanceManager,
	],
})
