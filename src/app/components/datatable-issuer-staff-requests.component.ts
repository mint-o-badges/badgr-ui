    ...
    template: `
        ...
        <hlm-table *ngIf="requests.length > 0" class="tw-rounded-t-[20px] tw-overflow-hidden tw-w-full tw-max-w-[100%] tw-bg-white tw-border-lightgrey tw-border">
            <hlm-trow class="!tw-bg-lightgreen tw-text-oebblack tw-flex-wrap hover:tw-bg-lightgreen">
                ...
                <!-- E-Mail -->
                <hlm-th class="tw-text-oebblack tw-w-[25%] tw-px-4 tw-text-center">E-Mail</hlm-th>
                <!-- Requested On -->
                <hlm-th class="tw-text-oebblack tw-w-[25%] tw-px-4 tw-text-center">Requested On</hlm-th>
                <!-- Actions -->
                <hlm-th class="tw-text-oebblack tw-w-[25%] tw-px-4 tw-text-right">Actions</hlm-th>
            </hlm-trow>
            <hlm-trow *ngFor="let request of requests" class="tw-border-purple tw-flex-wrap tw-py-2">
                ...
                <hlm-th class="tw-w-[25%] tw-px-4 tw-flex tw-items-center">
                    <span class="tw-text-oebblack tw-cursor-pointer tw-truncate">
                ...
                <hlm-th class="tw-w-[25%] tw-px-4 tw-text-center tw-flex tw-items-center">
                    <p hlmP class="tw-font-normal tw-truncate">{{request.user.email}}</p>
                </hlm-th>
