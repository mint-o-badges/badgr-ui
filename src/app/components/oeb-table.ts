...
@Directive({
	...
	providers: [
		provideHlmTableConfig({
			...
			td: 'tw-px-4 tw-py-2 tw-leading-10 tw-border-b tw-border-solid tw-border-purple',
			caption: '',
		}),
	],
})
...
@Directive({
	...
	providers: [
		provideHlmTableConfig({
			...
			td: 'tw-px-4 tw-py-2 tw-leading-10 tw-border-b tw-border-solid tw-border-gray-100',
			caption: '',
		}),
	],
})
