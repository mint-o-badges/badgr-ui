...
@Directive({
	...
	providers: [
		provideHlmTableConfig({
			...
			th: 'tw-px-4 tw-py-2 tw-leading-[3rem] tw-border-b tw-border-solid tw-border-purple tw-align-middle',
...
@Directive({
	...
	providers: [
		provideHlmTableConfig({
			...
			tfoot: '',
			tr: '[&:last-child_td]:tw-border-none',
			th: 'tw-px-4 tw-py-2 tw-leading-[3rem] tw-border-b tw-border-solid tw-border-gray-100 tw-align-middle',
