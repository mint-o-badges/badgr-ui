...
@Component({
	...
	imports: [HlmTableModule, CommonModule, TranslateModule, RouterModule],
	template: ` <hlm-table
	...
	>
		...
		>
			...
			<hlm-th class="!tw-text-white tw-justify-end tw-w-40 md:!tw-flex !tw-block tw-text-right md:tw-text-left"
