...
export const spinnerVariants = cva('tw-inline-block', {
	variants: {
		variant: {
			default: 'tw-animate-spin [&>svg]:tw-text-foreground/30 [&>svg]:tw-fill-accent',
		},
		size: {
			xs: 'tw-h-4 tw-w-4',
			sm: 'tw-h-6 tw-w-6',
...
@Component({
	...
	template: `
		<svg aria-hidden="true" class="tw-animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
