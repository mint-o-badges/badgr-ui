...
export const tabsVariants = cva('', {
	variants: {
		variant: {
			default:
				'data-[state=inactive]:tw-border-white data-[state=active]:tw-text-purple data-[state=active]:tw-border-purple',
